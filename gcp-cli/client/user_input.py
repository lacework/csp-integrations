...
def getProjectId(util):
    ...
    if projectSource == "y" or projectSource == "yes":
        ...
        while True:
            projectNumber = input("Enter the project number to select the project:\n")
        ...
        while True:
            projectId = input("Enter the project ID for the setup project for the new integration(s):\n")
...
def getConfigInput():
    ...
    if userInput == "n" or userInput == "no":
        ...
        while True:
            setupPrefix = input("Enter a setup string that will be prefixed to each resource name created by this script. (Do not specify a space or special characters except '-'):\n")
            if ' ' in setupPrefix:
        ...
        while True:
            complianceAndAudit = input("What types of integrations do you want to create? \n1. Compliance Only\n2. Compliance and Audit Trail\nPlease enter 1 or 2:\n")
            if complianceAndAudit == '1' or complianceAndAudit =='2':
                break
            else:
                print("Enter 1 or 2.")
        while True:
            complianceType = input("For compliance, do you want to integrate at the project or organization level?\nProject/Organization?\n")
            ...
            if complianceType == "PROJECT":
                ...
                while True:
                    complianceId = input("Enter the ID for the organization that you want to integrate with for compliance: \n")
        ...
        if complianceAndAudit == "2":
            ...
            if existingBucket == "y" or existingBucket == "yes":
                while True:
                    existingBucketName = input("Enter the existing bucket's name: \n")
            ...
            while True:
                auditType = input("For Audit logging, do you want to integrate at the project or organization level?\nProject/Organization\n")
                ...
                if auditType == "PROJECT":
                    ...
                    if complianceType == "ORGANIZATION":
                        ...
                        while True:
                            orgId = input("Enter the organization ID you want to integrate with for audit logging: \n")
